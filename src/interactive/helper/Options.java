//SCCSID "@(#) MQMBID sn=p900-L160518.TRIAL su=_7Y4jrR0LEearh6Qyg9d9Dg pn=MQJavaSamples/jms/interactive/helper/Options.java"
/*
 *   <copyright 
...
public class Options extends BaseOptions {
  ...
  static {
    ...
    helpMessage.put(Keys.Channel, new String[]{
        "The channel to use. An IBM MQ channel is a logical communication",
        "link between an IBM MQ client and an IBM MQ queue manager",
