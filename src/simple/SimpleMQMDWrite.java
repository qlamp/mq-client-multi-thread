// SCCSID "@(#) MQMBID sn=p900-L160518.TRIAL su=_7Y4jrR0LEearh6Qyg9d9Dg pn=MQJavaSamples/jms/simple/SimpleMQMDWrite.java"
/*
 *   <copyright 
...
public class SimpleMQMDWrite {
   ...
   * a newer version of the MQMD structure, refer to the IBM MQ documentation.
   * 
   ...
   * message context requires the current user to have appropriate IBM MQ authority. For the
   * information about Message context, refer to the IBM MQ documentation.
   * 
